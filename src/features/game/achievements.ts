...
export const ACHIEVEMENTS: Achievement[] = [
  { id: 'first-step', name: '初出茅庐', desc: '完成第 1 道默诵题', icon: '🌱', check: (s) => totalAnswered(s) >= 1 },
  ...
  { id: 'clear5', name: '过关斩将', desc: '通关 5 个关卡', icon: '🗡️', check: (s) => completedArticles(s) >= 5 },
  { id: 'clear10', name: '半壁江山', desc: '通关 10 个关卡', icon: '🏯', check: (s) => completedArticles(s) >= 10 },
  { id: 'clear20', name: '全胜将军', desc: '通关 20 个关卡', icon: '🏆', check: (s) => completedArticles(s) >= 20 },
  ...
  { id: 'streak3', name: '锲而不舍', desc: '连续历练 3 天', icon: '📅', check: (s) => s.streak >= 3 },
  { id: 'streak7', name: '焚膏继晷', desc: '连续历练 7 天', icon: '🏮', check: (s) => s.streak >= 7 },
  { id: 'big-xp', name: '一词千金', desc: '单题获得 15 XP（含连击加成）', icon: '💎', check: (s) => s.todayXp >= 15 && totalAnswered(s) >= 1 },
  { id: 'all-complete', name: '满腹经纶', desc: '完成全部关卡', icon: '🐉', hidden: true, check: (s) => completedArticles(s) >= 129 },
];
