...
## 2026-08-11 · 鉴赏/考点/注释 重难点标注 (08-11-keypoint-highlight)

用户: 三页增加重难点标注, 突出对比, 现在展示没有突出重难点。

### 实施
- 新共享组件 HighlightText: 对比行(1.原文：释义→左加粗右常规+圈号)、引号/书名号金句高亮、numbered 模式(名句默写圆点行)
- 考点页: 每卡标题行加徽章 (重点=橙 / 难点=红, 启发式: detail 含 易/勿/注意/区别/陷阱 → 难点); 通假字/古今异义/词类活用 自动对比行渲染; 名句默写行首圆点
- 鉴赏页: 主旨/结构/写法/文化 内容引号高亮; 写法每条 ①②③ 序号
